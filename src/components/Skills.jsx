    ...
    <div name='/skills' className='w-full h-screen bg-[#0a192f] text-white'>
      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          ...
          <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
              <div className='shadow-md shadow-[#040c16] hover:rotate-180 scale-110 duration-500'>
              ...
              <div className='shadow-md shadow-[#040c16] hover:rotate-180 scale-110 duration-500'>
                  <img className='w-20 py-2 mx-auto' src={JavaScript} alt="Javascript icon" />
              ...
              <div className='shadow-md shadow-[#040c16] hover:rotate-180 scale-110 duration-500'>
                  <img className='w-20 py-2 mx-auto' src={GitHub} alt="Github icon" />
                  <p className='my-2'>GITHUB</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:rotate-180 scale-110 duration-500'>
                  <img className='w-20 py-2 mx-auto' src={clogo} alt="C++ icon" />
                  <p className='my-2'>C++</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:rotate-180 scale-110 duration-500'>
                  <img className='w-20 py-2 mx-auto' src={Mongo} alt="Mongodb icon" />
                  <p className='my-2'>MONGO DB</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:rotate-180 scale-110 duration-500'>
                  <img className='w-20 py-2 mx-auto' src={sql} alt="Mysql icon" />
